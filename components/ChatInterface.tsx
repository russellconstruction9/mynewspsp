...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ 
    ...
    if (lastGeneratedReport) {
        return (
            <div className="flex flex-col h-full bg-white border border-gray-200 rounded-lg shadow-sm items-center justify-center text-center p-6">
    ...
    return (
        <div className="flex flex-col h-full bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div className="p-4 sm:p-6 border-b border-gray-200">
                <h1 className="text-2xl font-bold text-gray-900 tracking-tight">New Incident Report</h1>
            ...
            <div className="p-4 bg-white border-t border-gray-200 rounded-b-lg">
                ...
                <div className="relative">
                    ...
                    <textarea
                        ...
                        placeholder="Or, describe a new incident here..."
                        rows={1}
                    ...
                    <div className="absolute right-3 top-1/2 -translate-y-1/2">
                        <button onClick={() => handleSendMessage()} disabled={isLoading || (!input.trim() && uploadedFiles.length === 0)} className="p-2 text-white bg-blue-950 rounded-full hover:bg-blue-800 disabled:bg-blue-300 disabled:cursor-not-allowed transition-colors" aria-label="Send message">
